 ...
 * @subpackage Datum_Property_Listing/public
 */
 ...
 */
class Datum_Property_Listing_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/datum-property-listing-public.css', array(), $this->version, 'all' );
